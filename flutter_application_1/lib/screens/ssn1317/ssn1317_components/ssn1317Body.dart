          ...
          Align(
            ...
            child: Padding(
              ...
              child: NextButton(
                ...
                destinationScreen:
                    const lastScreen(), // Replace HomeScreen() with the desired screen widget
              ),
            ),
          ),
          const Align(
              ...
              child: EspanolButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          const spanSsn1317(), // Replace EspanolScreen() with the desired screen widget
                    ),
                  );
                },
                destinationScreen:
